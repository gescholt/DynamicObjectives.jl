...
using Dynamic_objectives: DataStructures, ModelingToolkit
import Dynamic_objectives: ODEProblem, Tsit5, Vern9, AutoTsit5, Rosenbrock23
using Test
...
# in Dynamic_objectives' [deps] (ForwardDiff support is duck-typed — callers
# bring their own AD backend). The test file exists for manual runs:
#   julia --project=pkg/Dynamic_objectives -e 'using Pkg; Pkg.add(["ForwardDiff","FiniteDiff"]); include("test/test_gradient_compatibility.jl")'
