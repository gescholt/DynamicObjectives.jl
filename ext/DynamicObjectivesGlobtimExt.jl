...
Triggered by: using Dynamic_objectives; using Globtim; using GlobtimPostProcessing
"""
...
import Dynamic_objectives: run_experiment_from_config, _resolve_solver
import Dynamic_objectives:
...
```
"""
function Dynamic_objectives.run_experiment_from_config(path::String; io::IO = stdout)
