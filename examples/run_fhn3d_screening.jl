# Run with: julia --project=. Dynamic_objectives/examples/run_fhn3d_screening.jl
#
...
#   julia --project=. -e 'using Dynamic_objectives, Globtim, GlobtimPostProcessing;
#       run_experiment_from_config("Dynamic_objectives/examples/configs/fhn3d_basic.toml")'
...
# Repo root (scripts live in Dynamic_objectives/examples/)
