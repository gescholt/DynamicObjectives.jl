#!/usr/bin/env julia
"""
Test integration with Globtim and GlobtimPostProcessing (Phase 2 compatible)
...
# ==============================================================================
# Step 2: Configure and Run Globtim
# ==============================================================================
...
display_section("Step 3: Stage 1 - Find Raw Critical Points (Globtim)")

# Run standard experiment (Phase 2: keyword arguments)
t_start = time()
result = run_standard_experiment(
    objective_function = objective,
    objective_name = "lv2d_integration_test",
    bounds = bounds,
...
display_section("Step 4.5: Gradient Validation")
