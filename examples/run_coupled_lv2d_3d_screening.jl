# Run with: julia --project=profiles/dev --threads=auto pkg/Dynamic_objectives/examples/run_coupled_lv2d_3d_screening.jl
#
...
#   cp globtim_results/coupled_lv2d_3d_catalogue.jsonl pkg/Dynamic_objectives/paper/catalogue/
