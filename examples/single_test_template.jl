...
println("="^80)
println("Dynamic_objectives - Single Model Test Template")
println("="^80)
...
# Choose your model (see MODEL_CATALOG.md for all options)
...
println("  3. See examples/batch_test_campaign.jl for running multiple models")
println("="^80)
