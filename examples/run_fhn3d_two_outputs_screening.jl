# Run with: julia --project=profiles/dev --threads=auto pkg/DynamicObjectives/examples/run_fhn3d_two_outputs_screening.jl
#
...
#   cp globtim_results/fhn3d_two_outputs_catalogue.jsonl pkg/DynamicObjectives/paper/catalogue/
