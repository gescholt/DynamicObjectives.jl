...
Configuration library with 14 benchmark models:
- Complete configs organized by difficulty phase
...
1. Run on Easy models first using `single_test_template.jl`
2. Progress to Medium, then Hard
3. Analyze results

### Phase 3: Full Evaluation

1. Load all configs from `test_configs.jl`
2. Run comprehensive campaign on all models
...
└── test_configs.jl             # Configuration library (14 benchmark models)
```
...
- **[Model Catalog](../docs/src/model_catalog.md)** - All 29 models reference
