...
#
# Usage:
#   julia --project=profiles/dev --threads=auto pkg/Dynamic_objectives/examples/run_3d_landscape_search.jl
#
...
function main()
    ...
    println(
        "    2. Visualize best candidates: julia --project=profiles/dev --threads=auto pkg/Dynamic_objectives/examples/level_set_animation_3d.jl <catalogue>.jsonl",
    )
    println(
